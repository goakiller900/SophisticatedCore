...
public record ItemDisplayPreviewRenderState(TrackingItemStackRenderState itemStackRenderState, Matrix3x2fc pose, @Nullable ScreenRectangle scissorArea, int x0,
