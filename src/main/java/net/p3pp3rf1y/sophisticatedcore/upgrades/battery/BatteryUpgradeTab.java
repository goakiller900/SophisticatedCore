...
public class BatteryUpgradeTab extends UpgradeSettingsTab<BatteryUpgradeContainer> {
	...
	protected void moveSlotsToTab() {
		...
		positionSlot(slots.get(BatteryUpgradeWrapper.INPUT_SLOT), screen.sophisticatedCore_getGuiLeft(), screen.sophisticatedCore_getGuiTop(), 4);
		positionSlot(slots.get(BatteryUpgradeWrapper.OUTPUT_SLOT), screen.sophisticatedCore_getGuiLeft(), screen.sophisticatedCore_getGuiTop(), 25);
	}
