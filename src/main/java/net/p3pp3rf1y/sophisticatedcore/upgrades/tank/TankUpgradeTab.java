...
public class TankUpgradeTab extends UpgradeSettingsTab<TankUpgradeContainer> {
	...
	protected void moveSlotsToTab() {
		...
		positionSlot(slots.get(TankUpgradeWrapper.INPUT_SLOT), screen.sophisticatedCore_getGuiLeft(), screen.sophisticatedCore_getGuiTop(), 4, 0);
		positionSlot(slots.get(TankUpgradeWrapper.OUTPUT_SLOT), screen.sophisticatedCore_getGuiLeft(), screen.sophisticatedCore_getGuiTop(), 25, 0);
	}
